...
class ShibAuthToken implements IAuthentication {
    ...
    private function getAttributesInitToken(){
        ...
        if ($idp == 'https://b2access.eudat.eu:8443/saml-idp/metadata' || $idp == 'https://unity.eudat-aai.fz-juelich.de:8443/saml-idp/metadata') {
	    ...
	    //$this->userDetails = array('AuthenticationRealm' => array('EUDAT IdP (devel)'));
